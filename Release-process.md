...
- [Branching Model](Branching-model.md) - Git workflow and branch strategy
- [How to Contribute](How-to-contribute.md) - Contribution guidelines including release preparation
- [Completed Features: Release Process PRD](completed-features/RELEASE_PROCESS_PRD.md) - Original PRD documenting the design and implementation
