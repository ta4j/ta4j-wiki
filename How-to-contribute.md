...
* Stay in scope of your pull request. Do not make changes all over the project in one pull request. For example if you want to add a new indicator, but you also found bugs or little enhancements on `TimeSeries` and `TrandingRecord` **fix them in a new pull request**.
