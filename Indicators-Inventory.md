...
| `org.ta4j.core.indicators.forecast.projection` | **Forecast** | Forecast summary value model used by projection indicators, with sample-based and summary-only construction. |
